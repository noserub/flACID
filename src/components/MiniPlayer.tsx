  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed md:absolute left-1/2 md:top-1/2 bottom-2 md:bottom-auto -translate-x-1/2 md:-translate-y-1/2 z-[45] flex items-center gap-2 md:gap-3 px-3 md:px-4 py-2 rounded-xl bg-background/90 backdrop-blur-md border border-cyan-500/20 shadow-lg w-[calc(100vw-1rem)] max-w-[calc(100vw-1rem)] md:min-w-[280px] md:max-w-[420px]"
