import { MOTION_POLICY, RESPONSIVE_BEHAVIOR, LAYOUT_TOKENS } from '../../lib/designSystemRegistry';
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-4 text-xs text-muted-foreground rounded-lg border border-neon-green/25 bg-neon-green/5 px-3 py-2">
          <span className="text-neon-green font-medium">prefers-reduced-motion: </span>
          {MOTION_POLICY.reducedMotion}
        </p>
      </div>

      <div>
        <p className="text-sm font-medium text-foreground mb-3">Responsive decisions</p>
      ...
      <div>
        <p className="text-sm font-medium text-foreground mb-3">Z-index scale</p>
