        ...
        >
          <div className="mx-auto w-full max-w-[20rem] shrink-0 sm:max-w-[23rem] lg:mx-0 lg:max-w-[26rem] lg:pt-7 xl:max-w-[28rem]">
            <motion.figure
              className={cn(
                ...
                'hover:border-neon-green/35 hover:shadow-[0_0_32px_rgba(74,222,128,0.12),0_12px_40px_rgba(0,0,0,0.45)]',
                'aspect-[3/2]'
              )}
              initial={{ opacity: 0 }}
          ...
          <div className="relative z-10 flex min-w-0 flex-1 flex-col justify-start">
            ...
            >
              ...
              {parsed.body && (
                <div className="whitespace-pre-wrap text-base leading-[1.75] text-foreground/82 sm:text-lg">
                  {parsed.body}
                </div>
              )}
              ...
              {parsed.members.length > 0 && (
                <div className="pt-4">
                  <SectionEyebrow className="mb-4">The band</SectionEyebrow>
